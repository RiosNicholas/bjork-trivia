...
const FlashCardButtons = ({ onRandomize, currentQuestion, setCurrentQuestion, handleLeftArrowClick, handleRightArrowClick }) => {
    ...
    return (
        <div className="flex items-center justify-center h-full">
            ...
            <div className="flex flex-col w-40 justify-center m-2" >
                <button onClick={randomizeQuestion} className="bg-blue-600 text-white rounded-lg shadow-lg w-40 m-2" id='randomize-button'>Randomize</button>
